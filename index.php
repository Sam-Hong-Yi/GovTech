<html lang="en">
    ...
    <body onload="initialize()">
        ...
        <br/>
        <h2 style="font-size:2em">Instructions: Click a box to place your mark on the square, alternatively, enter a number from 1 to 9 and press enter to place your mark on the corresponding square</h2>
        <br/>
        <h2 style="font-size:2em">Game Rules: First person to fill a row, column or diagonal on the board with their mark wins!</h2>
        <table id="table_game">
        ...
        <div style=" font-size:1.5em; position:fixed; top:12em; padding-left: 200px"> 
            <h3>Move History</h3>
            <div id="moveHistory" >
        ...
        <div id="optionsDlg" class="modal" >
            ...
            <!-- Modal content -->
            <div class="modal-content">
                <h2>Which role would Player 1 like to play as? <br/> Type x(starts first) or o before clicking play to start the game!</h2>
                <!--          <h3>Difficulty:</h3>
      ...
      <!--          <label><input type="radio" name="player" id="rx" value="x" checked>X (go first)&nbsp;</label>
                ...
                <!--    for the user input for accessibility-->
                <div id="userInput">
                    <label for="roleNumber" style="font-size: 1em" required>Enter x or o:</label>
                    <input type="letter" maxlength="1" id="roleNumber" autofocus>
...
// Check if the game is over and determine winner
    ...
    function getOptions() {
        ...
        if (document.getElementById('roleNumber').value === "x") {
            player1 = x;
            player2 = o;
            whoseTurn = player1;
            playerText = xText;
            computerText = oText;
        } else if (document.getElementById('roleNumber').value === "o") {
            player1 = o;
            player2 = x;
            whoseTurn = player2;
            playerText = oText;
    ...
    function setFocusOnInput2() {
        // Get the input element by its ID
        var roleInput = document.getElementById("roleNumber");
